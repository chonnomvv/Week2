...
<body>
	...
	<form action="process_regist.jsp" method="post">
		<table>
			...
			<tr>
				<td>우편번호</td>
				<td><input type="text" name="zip1" size="3"
					value="<%=vo.getZip1()%>">- <input type="text" name="zip2"
					size="3" value="<%=vo.getZip2()%>"></td>
				<td></td>
				<td></td>
			</tr>
			<tr>
			...
			<tr>
				<td>사용언어</td>
				<td><input type="checkbox" name="lang" value="0"
					<%=vo.getLang()[0].equals("0") ? "checked" : ""%>>자바 <input
					type="checkbox" name="lang" value="1"
					<%=vo.getLang()[1].equals("1") ? "checked" : ""%>>파이썬 <input
					type="checkbox" name="lang" value="2"
					<%=vo.getLang()[2].equals("2") ? "checked" : ""%>>C++ <input
					type="checkbox" name="lang" value="3"
